...
public class AmethystTurbinePoweredLoopSoundProcedure {
		...
		if (new Object() {
			...
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, BlockPos.containing(x, y, z), WashedMineralsModSounds.FAN, SoundSource.BLOCKS, (float) 0.5, 1);
				} else {
					_level.playLocalSound(x, y, z, WashedMineralsModSounds.FAN, SoundSource.BLOCKS, (float) 0.5, 1, false);
				}
			}
		} else {
